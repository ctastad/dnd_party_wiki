...
* *Circumstances:*
    - The party has just been trasported to the PT pocket dimension and will have to navigate their way out.
...
* After the confruntation with what were assumed to be agents of the terrorist group, the Progenitor Trust, the party found themselves in a sort of pocket dimension.
  The space carried a setting not unfamilar from their home plane but was clearly embued with magical parameters
...
1. 1 x Giant Boar (cr 2, mm 323); easy, 450 xp; treasure 4 pp
1. 1 x Redcap (cr 3, vgm 188); medium, 700 xp; treasure 14 gp
1. Green Hag (cr 3, mm 177) and 1 x Boggle (cr 1/8, vgm 128); medium, 725 xp; treasure 18 gp + 17 cp
1. Hobgoblin Devastator (cr 4, vgm 161) and 1 x Hobgoblin (cr 1/2, mm 186); deadly, 1200 xp; treasure 5 gp + 8 ep
1. Xvart Warlock of Raxivort (cr 1, vgm 200) and 3 x Xvart (cr 1/8, vgm 200); medium, 275 xp; treasure 12 gp + 18 cp + 19 cp + 4 pp
1. 2 x Bronze Scout (cr 1, mtf 125); medium, 400 xp; treasure 16 sp + 17 sp
1. Gnoll Fang of Yeenoghu (cr 4, mm 163) and 1 x Gnoll (cr 1/2, mm 163); deadly, 1200 xp; treasure 9 ep + 9 gp
1. 1 x Manticore (cr 3, mm 213); medium, 700 xp; treasure 8 gp
1. 2 x Half-ogre (cr 1, mm 238); medium, 400 xp; treasure 17 cp + 16 cp
1. Firenewt Warlock of Imix (cr 1, vgm 143) and 3 x Firenewt Warrior (cr 1/2, vgm 142); deadly, 500 xp; treasure 16 sp + 15 sp + 12 gp + 13 cp
...
1. Gnoll Fang of Yeenoghu (cr 4, mm 163) and 1 x Gnoll (cr 1/2, mm 163); deadly, 1200 xp; treasure 16 cp + 16 sp
1. 1 x Wereboar (cr 4, mm 209); deadly, 1100 xp; treasure 18 sp
1. 1 x Gnoll Flesh Gnawer (cr 1, vgm 154) and 1 x Maw Demon (cr 1, vgm 137); medium, 400 xp; treasure 8 gp + 18 cp
1. 1 x Ogre (cr 2, mm 237); easy, 450 xp; treasure 14 sp
1. 1 x Vampiric Mist (cr 3, mtf 246); medium, 700 xp; treasure 11 gp
1. 3 x Giant Vulture (cr 1, mm 329); deadly, 600 xp; treasure 22 cp + 8 gp + 11 gp
1. Barghest (cr 4, vgm 123) and 1 x Goblin (cr 1/4, mm 166); deadly, 1150 xp; treasure 17 cp + 10 gp
1. 2 x Giant Vulture (cr 1, mm 329); medium, 400 xp; treasure 15 cp + 13 sp
1. 2 x Hippogriff (cr 1, mm 184); medium, 400 xp; treasure 9 sp + 9 gp
1. 1 x Veteran (cr 3, mm 350); medium, 700 xp; treasure 17 cp
...
1. 1 x Manticore (cr 3, mm 213); medium, 700 xp; treasure 14 sp
1. 2 x Giant Eagle (cr 1, mm 324); medium, 400 xp; treasure 14 gp + 16 cp
1. 1 x Tortle Druid (cr 2, mtf 242) and 1 x Tortle (cr 1/4, mtf 242); medium, 500 xp; treasure 7 ep + 11 gp
1. 1 x Plesiosaurus (cr 2, mm 80); easy, 450 xp; treasure 12 cp
1. 1 x Plesiosaurus (cr 2, mm 80); easy, 450 xp; treasure 7 gp
1. 1 x Ogre (cr 2, mm 237); easy, 450 xp; treasure 13 sp
1. 1 x Veteran (cr 3, mm 350); medium, 700 xp; treasure 16 cp
1. 3 x Giant Eagle (cr 1, mm 324); deadly, 600 xp; treasure 14 cp + 18 sp + 18 cp
1. 1 x Banshee (cr 4, mm 23); deadly, 1100 xp; treasure 8 gp
1. 3 x Sea Spawn (cr 1, vgm 189); deadly, 600 xp; treasure 12 gp + 12 gp + 17 sp
...
1. 1 x Wererat (cr 2, mm 209); easy, 450 xp; treasure 13 sp
1. Dybbuk (cr 4, mtf 132) and 1 x Cultist (cr 1/8, mm 345); deadly, 1125 xp; treasure 20 cp + 14 cp
1. 1 x Phase Spider (cr 3, mm 334); medium, 700 xp; treasure 9 gp
1. Knight (cr 3, mm 347) and 4 x Commoner (cr 0, mm 344); medium, 740 xp; treasure 12 cp + 14 sp + 16 cp + 12 gp + 12 sp
1. 1 x Incubus (cr 4, mm 285); deadly, 1100 xp; treasure 12 sp
1. 3 x Spy (cr 1, mm 349); deadly, 600 xp; treasure 6 sp + 13 gp + 13 cp
1. 1 x Vampiric Mist (cr 3, mtf 246); medium, 700 xp; treasure 7 gp
1. 1 x Meenlock (cr 2, vgm 170) and 1 x Shadow (cr 1/2, mm 269); medium, 550 xp; treasure 12 ep + 8 gp
1. Kobold Scale Sorcerer (cr 1, vgm 167) and 7 x Kobold (cr 1/8, mm 195); hard, 375 xp; treasure 20 cp + 14 sp + 14 cp + 17 cp + 15 sp + 8 gp + 17 sp + 16 sp
1. Knight (cr 3, mm 347) and 4 x Commoner (cr 0, mm 344); medium, 740 xp; treasure 6 sp + 10 ep + 18 cp + 14 sp + 8 gp
...
1. Vegepygmy Chief (cr 2, vgm 197) and 1 x Vegepygmy (cr 1/4, vgm 196); medium, 500 xp; treasure 17 cp + 13 sp
1. 1 x Orc Red Fang of Shargaas (cr 3, vgm 185); medium, 700 xp; treasure 15 gp
1. 3 x Giant Toad (cr 1, mm 329); deadly, 600 xp; treasure 18 sp + 20 cp + 20 cp
1. 1 x Redcap (cr 3, vgm 188); medium, 700 xp; treasure 11 ep
1. 3 x Meazel (cr 1, mtf 214); deadly, 600 xp; treasure 13 cp + 11 sp + 17 sp
1. 1 x Yeth Hound (cr 4, vgm 201); deadly, 1100 xp; treasure 15 sp
1. Grung Elite Warrior (cr 2, vgm 157) and 2 x Grung (cr 1/4, vgm 156); deadly, 550 xp; treasure 4 ep + 21 sp + 13 cp
1. Gnoll Pack Lord (cr 2, mm 163) and 1 x Gnoll (cr 1/2, mm 163); medium, 550 xp; treasure 9 sp + 12 gp
1. 1 x Yuan-ti Malison (cr 3, mm 309); medium, 700 xp; treasure 20 cp
1. 3 x Tiger (cr 1, mm 339); deadly, 600 xp; treasure 15 sp + 20 cp + 10 gp
...
* **Description:** This is a strip mine under recent development by Lady Luna Laurentz.
* **NPCs:**
    - Lady Luna
    - Nidei the Accursed
