...
* Created a conductive arcane energy device that allows for the measurement of energy transfer. Uses a unipolar gate that relies on a field effect.- The device is two concentric circles mounted in a substrate. The circles are composed of varying specialized alloys that mark both points of human interface for the user along with the location of the central logic gate wear measurement that takes place in the material of the device.
